...
SECRET_KEY = 'django-insecure-=h-*yh3y_!$@-cpkh%5k-&wmxw%0)u_7b6-e^tw*lh0^ap#tc+'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'oscarnyeba@gmail.com'  # Your Gmail address
EMAIL_HOST_PASSWORD = 'nfxq hcog liky eipy'
